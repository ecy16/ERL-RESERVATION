...
export declare class ContractDetailsController {
    ...
    addContractDetail(body: CreateContractDetailDto): Promise<import("../entities/contract-detail.entity").ContractDetailEntity>;
    findAll(): Promise<any>;
    getOneContractDetailsById(id: string): Promise<import("../entities/contract-detail.entity").ContractDetailEntity>;
    ...
    update(id: string, updateContractDetailDto: UpdateContractDetailDto): Promise<import("../entities/contract-detail.entity").ContractDetailEntity>;
