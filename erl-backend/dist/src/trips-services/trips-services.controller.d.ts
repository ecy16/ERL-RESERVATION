...
export declare class TripsServicesController {
    ...
    fetchService(id: string): Promise<import("src/entities/tripServices.entity").TripServicesEntity>;
    fetchAllServices(): Promise<import("src/entities/tripServices.entity").TripServicesEntity[]>;
    addNewService(body: AddTripServicesDto): Promise<import("src/entities/tripServices.entity").TripServicesEntity>;
    updateService(id: string, body: UpdateTripServicesDto): Promise<import("src/entities/tripServices.entity").TripServicesEntity>;
