...
export declare class ChaufferDriversController {
    ...
    getAllChauffers(): Promise<import("../entities/chauffer-driver.entity").ChaufferDriverEntity[]>;
    addChaufferDriver(body: AddDriversDto): Promise<import("../entities/chauffer-driver.entity").ChaufferDriverEntity>;
